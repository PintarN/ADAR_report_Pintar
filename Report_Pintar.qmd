...
literature (Elhorst, 2014a; Scherngell, Borowiecki and Hu, 2014) Scherngell et al (2014) we
...
neighbourhood structure of our model and serves to include space into the modelling framework via spatially lagging dependent and independent variables (see Section below). The matrix $W$ will be defined in Section @sec-spatial. The last term in equation \ref{eq:sdm} ($\epsilon$) refers to an *iid* error term.
